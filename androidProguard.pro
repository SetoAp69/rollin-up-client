...
-dontwarn org.jetbrains.kotlinx.jupyter.api.ClassAnnotationHandler
-dontwarn org.jetbrains.kotlinx.jupyter.api.CodeCell
-dontwarn org.jetbrains.kotlinx.jupyter.api.DisplayResult
-dontwarn org.jetbrains.kotlinx.jupyter.api.FieldHandler$DefaultImpls
-dontwarn org.jetbrains.kotlinx.jupyter.api.FieldHandler
-dontwarn org.jetbrains.kotlinx.jupyter.api.FieldHandlerExecution
-dontwarn org.jetbrains.kotlinx.jupyter.api.FieldValue
-dontwarn org.jetbrains.kotlinx.jupyter.api.FieldsHandlingKt
-dontwarn org.jetbrains.kotlinx.jupyter.api.HtmlData
-dontwarn org.jetbrains.kotlinx.jupyter.api.InternalVariablesMarker
-dontwarn org.jetbrains.kotlinx.jupyter.api.JupyterClientType
-dontwarn org.jetbrains.kotlinx.jupyter.api.KotlinKernelHost
-dontwarn org.jetbrains.kotlinx.jupyter.api.KotlinKernelVersion$Companion
-dontwarn org.jetbrains.kotlinx.jupyter.api.KotlinKernelVersion
-dontwarn org.jetbrains.kotlinx.jupyter.api.MimeTypedResult
-dontwarn org.jetbrains.kotlinx.jupyter.api.MimeTypedResultEx
-dontwarn org.jetbrains.kotlinx.jupyter.api.Notebook
-dontwarn org.jetbrains.kotlinx.jupyter.api.Renderable
-dontwarn org.jetbrains.kotlinx.jupyter.api.RendererTypeHandler
-dontwarn org.jetbrains.kotlinx.jupyter.api.RenderersProcessor
-dontwarn org.jetbrains.kotlinx.jupyter.api.ResultHandlerExecution$DefaultImpls
-dontwarn org.jetbrains.kotlinx.jupyter.api.ResultHandlerExecution
-dontwarn org.jetbrains.kotlinx.jupyter.api.ResultsKt
-dontwarn org.jetbrains.kotlinx.jupyter.api.SubtypeRendererTypeHandler
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.ColorScheme
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.ColorSchemeChangedCallback
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.ExecutionHost
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.FieldHandlerFactory
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.JupyterIntegration$Builder
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.JupyterIntegration
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.ResourceBuildersKt
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.ResourcesBuilder$BundleBuilder
-dontwarn org.jetbrains.kotlinx.jupyter.api.libraries.ResourcesBuilder
-dontwarn org.jetbrains.kotlinx.jupyter.api.outputs.MetadataModifiersKt
...
-keep class org.jetbrains.kotlinx.dataframe.**{*;}
