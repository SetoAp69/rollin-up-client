...
class GetPermitByStudentPagingSource(
...
) : PagingSource<Int, PermitByStudentEntity>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PermitByStudentEntity> {
        ...
        val response = datasource.getPermitListByStudent(id, queryParams)
    ...
    override fun getRefreshKey(state: PagingState<Int, PermitByStudentEntity>): Int? {
